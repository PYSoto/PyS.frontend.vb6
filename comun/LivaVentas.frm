...
Dim ctlImp As New clsCtlImpresion
    ...
    ctlImp.printReport Me.crpLibro, "LIvaVentas", db.sconection, Array("sLocales"), Array(Array("pLibro", Val(Me.txtLibro.Text)), Array("pHojaDesde", Val(Me.txtPagina.Text)), Array("pDesde", toReportDate(Me.datDesde.Value)), Array("pHasta", toReportDate(Me.datHasta.Value)))
