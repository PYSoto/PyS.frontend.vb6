...
Public Function date2datetimeIso(fecha As Date, Optional last As Boolean = False) As String

    date2datetimeIso = Format(fecha, "yyyy-MM-ddT00:00Z")
    
    If last Then date2datetimeIso = Format(fecha, "yyyy-MM-ddT23:59Z")
...
Dim strCadena As String
    ...
    strCadena = Replace(strCadena, "É", "E")
    strCadena = Replace(strCadena, "Í", "I")
    strCadena = Replace(strCadena, "Ó", "O")
    strCadena = Replace(strCadena, "Ú", "U")
    ...
    strCadena = Replace(strCadena, "Ñ", "N")
