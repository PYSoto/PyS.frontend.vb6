...
Begin VB.MDIForm mdiPresupuesto 
   BackColor       =   &H8000000C&
   ...
   End
End
Attribute VB_Name = "mdiPresupuesto"
...
Private Sub mDepClientes_Click()
...
Private Sub MDIForm_Activate()
    ...
    Set gMDI = MDIPresupuesto

    gEmpresa.findLast db
    Me.Caption = cntArchivo & " - Módulo de Presupuesto - " & gEmpresa.nombre & " - " & gEmpresa.ubicacion
...
Private Sub mListaPres_Click()

    frmListaPres.Show
    
End Sub

Private Sub mPresupuesto_Click()
...
Public Sub mostrar(ByVal pMostrar As Boolean)
    ...
    Me.movim.Visible = pMostrar
    Me.venta.Visible = pMostrar
    Me.mMantenimiento.Visible = pMostrar
    Me.mConsultas.Visible = pMostrar
    If UCase(gUsuario.nombre) = "SANJUAN" Then Me.mConsultas.Visible = False
