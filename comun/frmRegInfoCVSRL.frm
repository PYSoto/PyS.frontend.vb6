...
Begin VB.Form frmRegInfoCVSRL 
   BorderStyle     =   1  'Fixed Single
   Caption         =   "Régimen de Información de Compras y Ventas - SRL"
   ClientHeight    =   2430
   ClientLeft      =   3270
   ClientTop       =   1845
   ClientWidth     =   7920
   ...
   Begin VB.CommandButton cmdArchivo 
      Height          =   255
      Left            =   7440
      Picture         =   "frmRegInfoCVSRL.frx":0000
      Style           =   1  'Graphical
      TabIndex        =   7
      Top             =   840
      Width           =   255
   ...
   End
End
Attribute VB_Name = "frmRegInfoCVSRL"
...
Dim colDB As New Collection
    ...
    modRegInfCV.makeFile "30-71158985-2", strPath, Me.dtpDesde.Value, Me.dtpHasta.Value, colDB, Me.stbEstado, Me.prbProgreso
